...
DEFINE_bool(enable_scenario_side_pass_multiple_parked_obstacles, false,
...
DEFINE_double(replan_lateral_distance_threshold, 0.6,
...
// DEFINE_double(replan_lateral_distance_threshold, 0.5,default
//               "The lateral distance threshold of replan");
// DEFINE_double(replan_longitudinal_distance_threshold, 1e10,
//               "The longitudinal distance threshold of replan");
...
DEFINE_double(planning_upper_speed_limit, 2.0,
...
DEFINE_double(speed_upper_bound, 2.0, "The highest speed allowed.");

DEFINE_double(longitudinal_acceleration_lower_bound, -2.0,
              "The lowest longitudinal acceleration allowed.");
DEFINE_double(longitudinal_acceleration_upper_bound, 2.0,
...
DEFINE_double(kappa_bound, 0.1538, "The bound for trajectory curvature");
...
// Decision Part
DEFINE_bool(enable_nudge_slowdown, false,
...
DEFINE_double(destination_check_distance, 1.0,
...
DEFINE_double(static_obstacle_speed_threshold, 0.5,
              ...
              "or not.");
DEFINE_double(lane_borrow_max_speed, 1.0,
...
DEFINE_double(speed_bump_speed_limit, 2.0,
              "the speed limit when passing a speed bump, m/s. The default "
              "speed limit is 10 mph.");
DEFINE_double(default_city_road_speed_limit, 2.0,
              "default speed limit (m/s) for city road. 35 mph.");
DEFINE_double(default_highway_speed_limit, 2.0,
